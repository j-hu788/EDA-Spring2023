...
```{r plot.Ozne2018, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Ozone Distribution in 2018", fig.align='left', fig.height= 2.5 }

EPA_plot_2018 <- epa_data %>%
filter(Year == 2018) %>%
ggplot(aes(
...
geom_boxplot() +
  labs(
    title ='Distribution of Ozone Level in 2018',
    x = 'Month',
    y = expression(paste('Ozone Level ('*mu~ '/' ~m^3*')')))+
theme_classic()
...
```{r plot.Ozne2019, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Ozone Distribution in 2019", fig.align='left', fig.height= 2.5 }

EPA_plot_2019 <- epa_data %>%
filter(Year == 2019) %>%
ggplot(aes(
(x=factor(Month,level=1:12, label= month.abb)),
y=Ozone)) +
geom_boxplot() +
  labs(
    title ='Distribution of Ozone Level in 2019',
    x = 'Month',
    y = expression(paste('Ozone Level ('*mu~ '/' ~m^3*')')))+
theme_classic()
