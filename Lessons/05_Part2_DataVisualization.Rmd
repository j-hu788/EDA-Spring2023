...
NvsP2 <-
  ...
  scale_shape_manual(values = c(15, 17)) + # change the shape 
...
library(cowplot)
plot_grid(NvsP2, Nutrientplot, nrow = 2, align = 'h', rel_heights = c(1, 1))
# rel_heights () is to adjust the space of plots
```
