...
NTL.phys.nutrient.data.PeterPaul2 <- inner_join(NTL.phys.data.PeterPaul.subset, NTL.nutrient.data.PeterPaul.subset)
NTL.phys.nutrient.data.PeterPaul3 <- anti_join(NTL.phys.data.PeterPaul.subset, NTL.nutrient.data.PeterPaul.subset)
NTL.phys.nutrient.data.PeterPaul4 <- left_join(NTL.phys.data.PeterPaul.subset, NTL.nutrient.data.PeterPaul.subset)
NTL.phys.nutrient.data.PeterPaul5 <- semi_join(NTL.phys.data.PeterPaul.subset, NTL.nutrient.data.PeterPaul.subset)
