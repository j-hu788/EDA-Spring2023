...
NTL.phys.data.Tuesday <- filter(NTL.phys.data, year4 >= 1990 & year4 <= 1999 & lakename == "Tuesday Lake")
```
...
NTL.phys.data.processed <- 
  ...
  mutate(month = month(sampledate)) %>%
   filter(lakename == "Tuesday Lake" & year4 >= 1990 & month == 7) 

# filter(lakename == "Tuesday Lake" & year4 >= 1990 & month (sampledate) == 7) 
...
NTL.gathered <- pivot_longer(NTL.phys.data,irradianceWater:irradianceDeck, names_to = "Irradiance Type", values_to = "Irradiance Value")
