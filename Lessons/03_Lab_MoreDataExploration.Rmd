...
```{r DataExercise-1a}
F_High <- c (75,80,88,90,70,90,66,78,64,55)
F_Low <- c (35,22,34,45,48,54,66,32,55,50)
```
...
```{r DataExercise-1c}
df_weather <- data_frame(LowF = F_Low, HighF = F_High,LowC = C_Low, HighC = C_High )
```
